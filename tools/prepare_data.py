...
def writeimage_with_bg2(arr,bg,alpha,filepath,if_sharp=False):
    print(arr.shape)
    ...
    radiance = arr*alpha + (1 - alpha) * bg
    print(radiance.shape)
    # radiance = crop_img(radiance)
    cv2.imwrite(filepath, radiance*255)
